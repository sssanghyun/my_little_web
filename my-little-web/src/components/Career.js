        ...
        <div id="career" className="section">
            ...
            <div className="career__career1">
                <div className="career__career1__icon">
                    <img
                        className="career__career1__symbol"
                        src="university.png"
                    ></img>
                </div>
                ...
                <div className="career__career1__comment">
                    ...
                    <div className="career__career1__title">협성대학교</div>
            ...
            <div className="career__career1">
                ...
                <div className="career__career1__comment">
                    ...
                    <div className="career__career1__subtitle">연구원 재직</div>
                    <div className="career__career1__subtitle">
                        담당업무 : S/W 개발, 데이터 관리, R&D 프로젝트 관리
                    </div>
                    <ul className="career__career1__ul">
                        <li className="career__career1__li">
                            - MERN(MySql, Express, React, Node.js) Web 개발 및
                            네트워크 구축&nbsp;&nbsp;
                            <a href="#portfolio">(링크)</a>
                        </li>
                        <li className="career__career1__li">
                            - ubuntu 환경 정수장 수열에너지 최적화
                            프로그램(Qt프레임워크) 유지보수
                        </li>
                        <li className="career__career1__li">
                            - 정수장 수열에너지 데이터 관리 및 분석(MySql,
                            Grafana)
                        </li>
                        <li className="career__career1__li">
                            - APT 탄소모니터링 안드로이드 App(Java) 및 서버
                            유지보수
                        </li>
                        <li className="career__career1__li">
